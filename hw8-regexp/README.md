...
## **RegExp-функции** - 2 штуки в папке `modules` в файле `for_files.py` - сделаны после дедлайна
...
**Никакой ИИ не использовала.**

2) **Короткие задачки чтобы набить руку.** 
...
**Музыка** для проверки домашки по буквам и словам - [песня про слова](https://www.youtube.com/watch?v=WAOpVxr4ba8)

Тут была другая музыка, сданная вовремя, но эта лучше, не снимайте баллы плиз :)
